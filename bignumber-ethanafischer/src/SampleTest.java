...
//        LinkedList num1 = new LinkedList(new Node(3));
//        LinkedList num2 = new LinkedList(new Node(4));
//        LinkedList expected = new LinkedList(new Node(2));
//        expected.insert(1);
//
//        LinkedList product = Calculations.multiply(num1, num2);
//
