...
public class PathingMain extends PApplet {
  ...
  */
   private boolean dfs(Point pos, GridValues[][] grid, List<Point> path, String str) {
      boolean check = false;
      ...
      if (withinBounds(pos, grid) &&
         ...
         if (grid[pos.y][pos.x] == GridValues.GOAL) {
            ...
            check = dfs(rightN, grid, path, "right") ||
                    dfs(leftN, grid, path, "left") ||
                    dfs(downN, grid, path, "down") ||
                    dfs(upN, grid, path, "up");
         }
      }
...
//         if(grid[pos.y][pos.x + 1] != GridValues.OBSTACLE &&
//                 grid[pos.y][pos.x + 1] != GridValues.SEARCHED){
//            System.out.println("right");
//            pos = new Point(pos.x + 1, pos.y);
//         } else {
//            System.out.println("down");
//            if(grid[pos.y + 1][pos.x] == GridValues.OBSTACLE ||
//                    grid[pos.y + 1][pos.x] == GridValues.SEARCHED){
//               pos = new Point(pos.x - 1, pos.y);
//            } else {
